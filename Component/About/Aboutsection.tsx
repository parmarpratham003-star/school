...
export default function AboutSection() {
  ...
  const items = [
    { icon: <GraduationCap size={20} />, title: "Interactive Learning" },
    { icon: <BookOpen size={20} />, title: "Creative Education" },
    { icon: <Laptop size={20} />, title: "Modern Classrooms" },
    { icon: <Users size={20} />, title: "Student Growth" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-14 items-center">
          ...
          <div className="slide-left flex justify-center order-2 lg:order-1">
            <div className="relative w-full max-w-[460px] mx-auto">
              ...
              <div className="absolute top-4 right-0 sm:top-6 bg-gray-500 text-white rounded-sm px-4 py-4 sm:px-5 sm:py-5 shadow-lg">
                <h3 className="hero-title text-2xl sm:text-3xl">10K+</h3>
          ...
          <div className="fade-up order-1 lg:order-2">
            <div className="w-full">
              ...
              <h2 className="hero-title text-[#0f1e45] text-[28px] sm:text-[38px] lg:text-[48px] leading-[1.15] mb-4 sm:mb-5">
                Shaping Young Minds
                <br />
                with{" "}
                <span className="text-orange-500">Knowledge &amp; Values</span>
              </h2>

              <p className="text-gray-500 text-sm sm:text-base font-normal leading-7 sm:leading-8 max-w-xl">
                Education is not just about textbooks. We help students grow
                with confidence, creativity, and practical learning that
                prepares them for a meaningful and successful future.
              </p>
              ...
              <button className="mt-6 sm:mt-8 group relative overflow-hidden bg-orange-500 text-white px-7 sm:px-8 py-3 sm:py-3.5 rounded-sm text-xs sm:text-sm font-extrabold uppercase inline-flex items-center gap-2 hover:bg-[#0f1e45] transition-colors duration-300">
