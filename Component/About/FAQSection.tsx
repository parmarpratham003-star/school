...
export default function FAQSection() {
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white pt-4 pb-12 sm:pt-6 sm:pb-14 lg:pt-5 lg:pb-18">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-10">
          ...
          <div className="mb-10 grid gap-6 lg:grid-cols-2 lg:items-end">
            ...
            <div>
              ...
              <p className="mb-3 text-[10px] font-bold uppercase tracking-[4px] text-orange-500 sm:text-xs">
                FAQ
              </p>

              <h2 className="hero-title text-[#0f1e45] text-[28px] sm:text-[36px] lg:text-[44px] leading-[1.18] tracking-[-0.02em]">
                Questions About
                <br />
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* TITLE */}
                    <h3
                      className={`hero-title mb-3 text-[18px] sm:text-[20px] font-medium tracking-[-0.02em] ${faq.textColor}`}
                    >
                      {faq.question}
                    </h3>
